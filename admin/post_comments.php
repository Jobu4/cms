...
<div class="col-xs-4">
    ...
    <tbody>
        <?php
        $query = "SELECT * FROM comments WHERE comment_post_id =" . mysqli_real_escape_string($connection, $_GET['id'] . " "); //CAN limit number of categories you want people to see
        ...
        while ($row = mysqli_fetch_assoc($select_comments)) {
            ...
            echo "<td><a onClick=\"javascript: return confirm('ARE you sure you want to delete??'); \" href='post_comments.php?delete=$comment_id&id=". $_GET['id'] ."'>Delete</td>";
            echo "</tr>";
        }
