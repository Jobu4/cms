...
<table class="table table-bordered table-hover ">
    ...
    <select name="bulk_options" id="bulkOptionsContainer" class="form-control" style="margin-left: -15px;">
    ...
    <tbody>
        <?php
        $query = "SELECT * FROM posts ORDER BY post_id DESC"; //CAN limit number of categories you want people to see
        ...
        while ($row = mysqli_fetch_assoc($select_posts)) {
            ...
            $query = "SELECT * FROM categories WHERE cat_id = $post_category_id "; //CAN limit number of categories you want people to see
